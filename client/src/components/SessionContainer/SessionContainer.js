...
class SessionContainer extends Component {
	...
	render(){
		return (
			<div>
				<div className="row row-eq-height justify-content-center session-container" style= {{backgroundColor: "rgb(247, 247, 249", paddingTop: "20px", display: "flex", margin: "auto"}}>
